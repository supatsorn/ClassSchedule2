...
public class AddThursday extends AppCompatActivity {
    ...
    private int thCount_i=1;
    public ArrayList<String> loca_thu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_thursday);
        ...
        //connect DB
        connectedSQLite();
        db = new MySQLiteOpenHelper(AddThursday.this);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
//                Intent intent = new Intent(AddThursday.this, Thursday.class);
...
// Apply the adapter to the spinner
                    ...
                    public void onClick(View v) {
                        ...
                        if (Sbj_name.matches("") || Sbj_num.matches("")) {
                            ...
                            if (isInserted = true) {
                                ...
                                Toast.makeText(AddThursday.this, "DATA not Inserted ", Toast.LENGTH_LONG).show();


                            Toast.makeText(AddThursday.this, "Click", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(AddThursday.this, Thursday.class);
                            startActivity(intent);
    ...
    public void openDialog(){
        ...
        alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent intent = new Intent(AddThursday.this, AddThursday.class);
                startActivity(intent);
    ...
    protected TimePickerDialog.OnTimeSetListener kTimePickerListener
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            Toast.makeText(AddThursday.this, formattedHour + ":" + formattedMinute, Toast.LENGTH_LONG).show();
        }
    };
    private void compareDates() throws ParseException {
        ...
        if ( dateCompareOne.before( date ) && dateCompareTwo.after(date)) {
            if ((today.equals("Thu"))||(today.equals("พฤ."))) {
            ...
            }Log.i("Today","Today is not thursday");
        }
    }
