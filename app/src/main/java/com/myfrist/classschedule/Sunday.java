...
public class Sunday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //connected SQLite
        connectedSQLite();
        db = new MySQLiteOpenHelper(Sunday.this);
        data = db.getWritableDatabase();
        db.close();

        //display Listview2
//        listView7 = (ListView)findViewById(R.id.listView7);
//        objClass_Schedule = new Class_Schedule(Sunday.this);
...
//        listView7.setAdapter(adapter);//เอา adepter ไปใส่ใน todoListView
        createListView();
...
//                return true;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.add_sun_menu,menu);
        return super.onCreateOptionsMenu(menu);
    }
    public boolean onOptionsItemSelected(MenuItem item) {

        Intent intent = new Intent(this,AddSunday.class);
