...
public class AddSaturday extends AppCompatActivity {
    ...
    private int saCount_i=1;
    public ArrayList<String> loca_sat;
...
// Apply the adapter to the spinner
                    ...
                    public void onClick(View v) {
                        ...
                        if (Sbj_name.matches("") || Sbj_num.matches("")) {
                            ...
                            boolean isInserted = objClass_Schedul.addNewClass_Schedule(sbj_name.getText().toString(),
                                    sbj_num.getText().toString(), Sat.toString(), settime.toString(), local_l
    ...
    public void openDialog(){
        ...
        alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent intent = new Intent(AddSaturday.this, AddSaturday.class);
                startActivity(intent);
    ...
    private void compareDates() throws ParseException {
        ...
        if ( dateCompareOne.before( date ) && dateCompareTwo.after(date)) {
            if ((today.equals("Sat"))||(today.equals("ส."))) {
            ...
            Log.i("Today ", "Today is not Saturday");
        }
    }
