...
public class AddMonday extends AppCompatActivity {
    ...
    int hour_x,minute_x;
    int local_l;
    String settime,Mon= "Mon",Tue="Tue",location;
    ...
    private int mCount_i=1;
    public ArrayList<String> loca_mon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_monday);
        ...
        //connect DB
        connectedSQLite();
        db = new MySQLiteOpenHelper(AddMonday.this);
...
// Apply the adapter to the spinner
        d_location.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view,
                ...
                Log.i("strLocationChooed",strLocationChooed);
                Log.i("strLocationChooed_l", String.valueOf(l));
...
// Apply the adapter to the spinner
    ...
    protected TimePickerDialog.OnTimeSetListener kTimePickerListener
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            Toast.makeText(AddMonday.this,formattedHour+":"+formattedMinute,Toast.LENGTH_LONG).show();
        }
    };
