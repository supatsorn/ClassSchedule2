...
public class AddFriday extends AppCompatActivity {
    ...
    private int fCount_i=1;
    public ArrayList<String> loca_fri;
...
// Apply the adapter to the spinner
    ...
    public void openDialog(){
        ...
        alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent intent = new Intent(AddFriday.this, AddFriday.class);
                startActivity(intent);
    ...
    private void compareDates() throws ParseException {
        ...
        if ( dateCompareOne.before( date ) && dateCompareTwo.after(date)) {
            if ((today.equals("Fri"))||(today.equals("ศ."))) {
            ...
            Log.i("Today ", "Today is not friday");
        }
    }
