...
public class AddSunday extends AppCompatActivity {
    ...
    int hour_x,minute_x;
    int local_l;
    String settime,Sun= "Sun",location;
    ...
    private int suCount_i=1;
    public ArrayList<String> loca_sun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_sunday);
        ...
        //connect DB
        connectedSQLite();
        db = new MySQLiteOpenHelper(AddSunday.this);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
//                Intent intent = new Intent(AddSunday.this, Sunday.class);
...
// Apply the adapter to the spinner
                    ...
                    public void onClick(View v) {
                        ...
                        if (Sbj_name.matches("") || Sbj_num.matches("")) {
                            ...
                            boolean isInserted = objClass_Schedul.addNewClass_Schedule(sbj_name.getText().toString(),
                                    sbj_num.getText().toString(), Sun.toString(), settime.toString(), local_l
                            ...
                            if (isInserted = true) {
                                ...
                                Toast.makeText(AddSunday.this, "DATA Inserted ", Toast.LENGTH_LONG).show();
                            } else
                                Toast.makeText(AddSunday.this, "DATA not Inserted ", Toast.LENGTH_LONG).show();


                            Toast.makeText(AddSunday.this, "Click", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(AddSunday.this, Sunday.class);
                            startActivity(intent);
    ...
    public void openDialog(){
        ...
        alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Intent intent = new Intent(AddSunday.this, AddSunday.class);
                startActivity(intent);
    ...
    protected TimePickerDialog.OnTimeSetListener kTimePickerListener
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            Toast.makeText(AddSunday.this, formattedHour + ":" + formattedMinute, Toast.LENGTH_LONG).show();
        }
    };
    ...
    private void compareDates() throws ParseException {
        ...
        if ( dateCompareOne.before( date ) && dateCompareTwo.after(date)) {
            if((today.equals("Sun"))||(today.equals("อา."))) {
            ...
            Log.i("Today ", "Today is not Sunday");
        }
    }
