...
public class Thursday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //connected SQLite
        connectedSQLite();
        db = new MySQLiteOpenHelper(Thursday.this);
        data = db.getWritableDatabase();
        db.close();

        //display Listview2
//        listView4 = (ListView)findViewById(R.id.listView4);
//        objClass_Schedule = new Class_Schedule(Thursday.this);
...
//        listView4.setAdapter(adapter);//เอา adepter ไปใส่ใน todoListView
        createListView();
    }
...
//                return true;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.add_thu_menu,menu);
        return super.onCreateOptionsMenu(menu);
    }
    public boolean onOptionsItemSelected(MenuItem item) {

        Intent intent = new Intent(this,AddThursday.class);
