...
public class AddTuesday extends AppCompatActivity {
    ...
    int hour_x,minute_x;
    String settime,Tue= "Tue",location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_tuesday);
        ...
        //connect DB
        connectedSQLite();
        db = new MySQLiteOpenHelper(AddTuesday.this);
...
// Apply the adapter to the spinner
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean isInserted = objClass_Schedul.addNewClass_Schedule(sbj_name.getText().toString(),
                                sbj_num.getText().toString(),Tue.toString(),settime.toString(),strLocationChooed.toString()
    ...
    protected TimePickerDialog.OnTimeSetListener kTimePickerListener
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            Toast.makeText(AddTuesday.this, formattedHour + ":" + formattedMinute, Toast.LENGTH_LONG).show();
        }
    };
